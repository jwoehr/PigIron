include(`pigfunc.m4')dnl \\ virtual_network_adapter_create.m4
function_namespace(`Virtual_Network_Adapter_Create')dnl
pigfunc_start()dnl
...
pigfunc_attribute(`private', `', `String', javaize_lc(`mac_id'), `null', `', `The MAC identifier')dnl
