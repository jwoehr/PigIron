include(`pigfunc.m4')dnl \\ virtual_channel_connection_delete_DM.m4
function_namespace(`Virtual_Channel_Connection_Delete_DM')dnl
pigfunc_start()dnl
 ...
 */')dnl
pigfunc_attribute(`private', `', `String', member_name(`image_device_number'), `""', `', `The virtual device number of the device to be deleted')dnl
