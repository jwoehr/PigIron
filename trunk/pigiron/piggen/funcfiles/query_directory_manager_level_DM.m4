include(`pigfunc.m4')dnl \\ query_directory_manager_level_DM.m4
function_namespace(`Query_Directory_Manager_Level_DM')dnl
...
pigfunc_compose_output_parm(`CountedString', `""', `directory_manager_level')dnl
