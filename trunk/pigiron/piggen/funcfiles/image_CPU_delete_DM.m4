include(`pigfunc.m4')dnl \\ image_CPU_delete_DM.m4
function_namespace(`Image_CPU_Delete_DM')dnl
...
pigfunc_attribute(`private', `', `String',  member_name(`cpu_address'), `""', `', `The virtual CPU address to delete from the static |definition of the virtual image in the hexadecimal range of 0-3F.')dnl
