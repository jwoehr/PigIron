include(`pigfunc.m4')dnl \\ directory_manager_task_cancel_DM.m4
function_namespace(`Directory_Manager_Task_Cancel_DM')dnl
...
pigfunc_attribute(`private', `', `int', member_name(`operation_id'), `-1', `', `The identifier of the task')dnl
...
pigfunc_function(`public', `static', `void', `', `main', `String[] argv', `IOException`,' VSMException', `dnl
     ...
     * @throws VSMException on internal Pigiron param marshalling error', `dnl
        ...
        if (argv.length != 6) {
            System.out.println("usage: args are:\ninetaddr port user pw target_name operation_id");
            System.exit(1);
        }
