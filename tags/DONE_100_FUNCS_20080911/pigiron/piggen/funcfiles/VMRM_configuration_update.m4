...
pigfunc_attribute(`private', `', `int', javaize_lc(`syncheck_only'), `0', `', `Specify a 1 to choose the SYNCHECK option meaning that only a syntax check is done and a 0 to indicate both a syntax check and a configuration file update')dnl
pigfunc_attribute(`private', `', `String', javaize_lc(`update_file'), `""', `', `A new complete VMRM configuration file to syntax-check or to replace the old file.')dnl
...
`String', `configuration_dir_name', javaize_lc(`configuration_dir_name'),
`int', `syncheck_only', javaize_lc(`syncheck_only'),
`String', `update_file', javaize_lc(`update_file'))dnl
...
pigfunc_compose_input_parm(`VSMInt1', `get_'javaize_lc(`syncheck_only')(), `syncheck_only')dnl
pigfunc_compose_input_parm(`CountedString', `get_'javaize_lc(`update_file')(), `update_file')dnl
