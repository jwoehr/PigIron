include(`pigstruct.m4')dnl \\ connected_adapter_structure.m4
...
pigparm_model_parm(`CountedString', `null', `adapter_owner')dnl
pigparm_model_parm(`CountedString', `null', `image_device_number')dnl
