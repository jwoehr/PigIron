include(`pigfunc.m4')dnl \\ image_password_set_DM.m4
function_namespace(`Image_Password_Set_DM')dnl
...
pigfunc_attribute(`private', `', `String', member_name(`image_password'),    `"*"', `', `The password to set for the image')dnl
pigfunc_ctors(`String', `image_password', member_name(`image_password'))dnl
pigfunc_compose_input_start()dnl
pigfunc_compose_input_parm(`CountedString', `getTarget_identifier()', `target_identifier')dnl
pigfunc_compose_input_parm(`CountedString', member_getter(`image_password')`()', `image_password')dnl
...
pigfunc_function(`public', `static', `void', `', `main', `String[] argv', `IOException`,' VSMException', `dnl
     ...
     * @throws VSMException on internal Pigiron param marshalling error', `dnl
        ...
        if (argv.length != 6) {
            System.out.println("usage: args are:\ninetaddr port user pw target_id image_password");
            System.exit(1);
        }
