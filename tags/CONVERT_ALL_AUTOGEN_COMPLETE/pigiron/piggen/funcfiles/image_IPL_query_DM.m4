include(`pigfunc.m4')dnl \\ image_IPL_query_DM.m4
function_namespace(`Image_IPL_Query_DM' )dnl
...
pigfunc_compose_output_parm(`CountedString', `""', `saved_system')dnl
pigfunc_compose_output_parm(`CountedString', `""', `load_parameter')dnl
pigfunc_compose_output_parm(`CountedString', `""', `parameter_string')dnl
