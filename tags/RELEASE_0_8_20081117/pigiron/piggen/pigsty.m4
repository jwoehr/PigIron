...
pushdef(`significant_parameter_membername', member_name(significant_parameter_formal_name))dnl
pushdef(`significant_parameter_member_getter', member_getter(significant_parameter_formal_name))dnl
')

# function_namespace_end()
define(`function_namespace_end')dnl
popdef(`significant_parameter_member_getter')dnl
popdef(`significant_parameter_membername')dnl
