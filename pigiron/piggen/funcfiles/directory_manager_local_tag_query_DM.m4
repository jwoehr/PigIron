include(`pigfunc.m4')dnl \\ directory_manager_local_tag_query_DM.m4
function_namespace(`Directory_Manager_Local_Tag_Query_DM')dnl
...
pigfunc_compose_output_parm(CountedString, `""', `tag_value')dnl
...
pigfunc_function(`public', `static', `void', `', `main', `String[] argv', `IOException`,' VSMException', `dnl
     ...
     * @throws VSMException on internal Pigiron param marshalling error', `dnl
        ...
        if (argv.length != 6) {
            System.out.println("usage: args are:\ninetaddr port user pw target_name tag_name");
            System.exit(1);
        }
