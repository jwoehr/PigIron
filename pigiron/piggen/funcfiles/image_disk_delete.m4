include(`pigfunc.m4')dnl \\ image_disk_delete.m4
function_namespace(`Image_Disk_Delete')dnl
pigfunc_start()dnl
 ...
 */')dnl
pigfunc_attribute(`private', `', `String', `javaize_lc(`image_disk_number')', `""', `', `The virtual device address of the disk to be copied')dnl
