...
pigfunc_compose_input_parm(`CountedString', `get_`'javaize_lc(`coupled_image_name')`()'', `coupled_image_name')dnl
pigfunc_compose_input_parm(`CountedString', `get_`'javaize_lc(`coupled_image_device_number')`()'', `coupled_image_device_number')dnl
