include(`pigfunc.m4')dnl \\ asynchronous_notification_enable_DM.m4
function_namespace(`Asynchronous_Notification_Enable_DM')dnl
...
pigfunc_constant(`public', `int', `SUBSCRIPTION_TYPE_INCLUDE', `1', `target_identifier will receive notifications for associated directory changes')dnl
...
`int', `subscription_type', member_name(`subscription_type'),
...
pigfunc_compose_input_parm(`VSMInt1', member_getter(`subscription_type')`()', `subscription_type')dnl
...
pigfunc_function(`public', `static', `void', `', `main', `String[] argv', `IOException`,' VSMException', `dnl
     ...
     * @throws VSMException on internal Pigiron param marshalling error', `dnl
        ...
        instance = new function_classname()(argv[0], Integer.valueOf(argv[1]).intValue(), argv[2], argv[3], argv[4],Integer.valueOf(argv[5]).intValue(), Integer.valueOf(argv[6]).intValue(), Integer.valueOf(argv[7]).intValue(), Integer.valueOf(argv[8]).intValue(), argv[9], Integer.valueOf(argv[10]).intValue(), argv[11]);
