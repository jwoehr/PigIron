...
pigfunc_function(`public', `static', `void', `', `main', `String[] argv', `IOException`,' VSMException', `dnl
     ...
     * @throws VSMException on internal Pigiron param marshalling error', `dnl
 	...
 	significant_parameter_classname spc = new significant_parameter_classname`(someval, notherval, astring, etc)';
        instance = new function_classname()(argv[0], Integer.valueOf(argv[1]), argv[2], argv[3], argv[4], argv[5], Integer.valueOf(argv[6]).intValue(), Integer.valueOf(argv[7]).intValue(), spc);
