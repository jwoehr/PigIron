...
pigfunc_import(`com.softwoehr.pigiron.access.paramstructs.DirectoryEntryFormatNoArray')dnl
...
pigfunc_compose_output_snippet(`dnl
        if(member_getter(`query_keyword_parameter_list')`()' == null
          || member_getter(`query_keyword_parameter_list')`()'.equals("")
          || member_getter(`query_keyword_parameter_list')`()'.equals("FORMAT=YES")) {')dnl
pigfunc_compose_output_parm(significant_parameter_classname, `null', significant_parameter_formal_name)dnl
pigfunc_compose_output_snippet(`dnl
        } else if(member_getter(`query_keyword_parameter_list')`()'.equals("FORMAT=NO")) {')dnl
pigfunc_compose_output_parm(`DirectoryEntryFormatNoArray', `null', `directory_entry_format_no_array')dnl
pigfunc_compose_output_snippet(`dnl
        } else { throw new Error("Unknown FORMAT= in QueryAllDM: " + member_getter(`query_keyword_parameter_list')`()'); }')dnl 
pigfunc_compose_output_end()dnl
dnl pigfunc_exception_class(`QueryAllDMFormatException')dnl
