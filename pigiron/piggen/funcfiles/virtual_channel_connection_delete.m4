include(`pigfunc.m4')dnl \\ virtual_channel_connection_delete.m4
function_namespace(`Virtual_Channel_Connection_Delete')dnl
pigfunc_start()dnl
 ...
 */')dnl
pigfunc_attribute(`private', `', `String', `javaize_lc(`image_device_number')', `null', `', `The virtual device number of the device to be deleted')dnl
