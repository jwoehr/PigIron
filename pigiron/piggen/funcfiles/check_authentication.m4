include(`pigfunc.m4')dnl \\ check_authentication.m4
function_namespace(`Check_Authentication')dnl
...
pigfunc_function(`public', `static', `void', `', `main', `String[] argv', `IOException`,' VSMException', `dnl
     ...
     * @throws VSMException on internal Pigiron param marshalling error', `dnl
        ...
        instance = new function_classname()(argv[0], Integer.valueOf(argv[1]), argv[2], argv[3]);
